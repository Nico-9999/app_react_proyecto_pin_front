...
function Accordions() {
  return (
    ...
    <div className="accordion-asd">   
    <div className="img-container">    
       <img src="./camagato2.jpg" alt="Imagen lateral" className="accordion-side-image" />
    </div>
    <div className="accordion-container">
    <div className="your-new-div">
      <Accordion defaultActiveKey="0" id="info" className="custom-accordion">
        <Accordion.Item eventKey="0" className="custom-accordion-item">
          <Accordion.Header className="custom-accordion-header" id="accordion-header-color">Nuestra idea</Accordion.Header>
